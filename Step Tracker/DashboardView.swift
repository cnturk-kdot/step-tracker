...
struct DashboardView: View {
    ...
    @State private var isShowingPermissionPriminSheet = false
    ...
    var body: some View {
        NavigationStack {
                                ...
                                RuleMark(x: .value("Selected Metric", selectedHealthMetric.date, unit: .day))
                                    ...
                                    .annotation(
                                        ...
                                        overflowResolution: .init(x: .fit(to: .chart), y:
                                                .disabled)) { annotationView//Text(selectedHealthMetric.value, format: .number)
                                                }
                            }
            ...
            .sheet(isPresented: $isShowingPermissionPriminSheet, onDismiss: {
                // fetch health data
            }, content: {
    ...
    var annotationView: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 4)
                ...
                .shadow(color: .secondary.opacity(0.3), radius: 2, x:
                            2, y: 2)
        )
    }
}
